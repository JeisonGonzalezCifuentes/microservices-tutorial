...
public class UserService {
    ...
    public List<Car> getAllCars(Integer userId){
        List allCarsByUser = restTemplate.getForObject("http://car-service/car/user/" + userId, List.class);
    ...
    public List<Bike> getAllBikes(Integer userId){
        List allBikesByUser = restTemplate.getForObject("http://bike-service/bike/user/" + userId, List.class);
